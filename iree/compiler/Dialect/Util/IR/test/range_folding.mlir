...
func @rangeExtentsFoldConstantsDynamic(%arg0: index, %arg1: index) -> (index, index) {
  ...
  %c2 = constant 2 : index
  %c3 = constant 3 : index
  // CHECK: %[[RANGE_MAX_EXC:.+]] = addi %arg0, %arg1
  // CHECK: %[[RANGE_MAX_INC:.+]] = subi %[[RANGE_MAX_EXC]], %c1
...
func @rangeExtentsExpand2(%arg0: index, %arg1: index, %arg2: index, %arg3: index) -> (index, index) {
  ...
  // CHECK: %[[RANGE0_MAX_EXC:.+]] = addi %arg0, %arg1
  // CHECK: %[[RANGE0_MAX_INC:.+]] = subi %[[RANGE0_MAX_EXC]], %c1
  // CHECK: %[[RANGE1_MAX_EXC:.+]] = addi %arg2, %arg3
  // CHECK: %[[RANGE1_MAX_INC:.+]] = subi %[[RANGE1_MAX_EXC]], %c1
